#!/usr/bin/env python3
"""Build a FiQA-2018 Task 1 (microblogs + headlines) agent-prob cache
...
the data loader (``DataConfig(dataset_name="fiqa2018")``) and the
output directory (``results/fiqa2018/``).

Outputs
-------
results/fiqa2018/_cache_agents.npz
results/fiqa2018/_cache_finbert.npz
results/finbert_finetuned_fiqa/   -- saved HF model + tokenizer
"""
...
OUT_DIR = RESULTS_DIR / "fiqa2018"
OUT_DIR.mkdir(parents=True, exist_ok=True)
FT_DIR = RESULTS_DIR / "finbert_finetuned_fiqa"
...
def main() -> None:
    t_total = time.time()
    print("=" * 70)
    print("  Building FiQA-2018 Task 1 agent-prob cache")
    print("=" * 70)

    cfg = DataConfig(dataset_name="fiqa2018")
    ...
    print("\n  [1/4] TF-IDF + LogReg (fit on FiQA-2018 train)")
    ...
    print("\n  [3/4] GPT-4o-mini zero-shot on FiQA-2018 val+test")
    ...
    print("\n  [4/4] Fine-tuning FinBERT on FiQA-2018")
    ...
    targs = TrainingArguments(
        output_dir=str(RESULTS_DIR / "_finbert_fiqa_trainer_scratch"),
